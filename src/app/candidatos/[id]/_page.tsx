...
import {
  User, FileText, Briefcase, MapPin, Calendar, Phone, Mail, Award,
  ChevronLeft, Clipboard, Instagram, Linkedin, Facebook, CheckCircle, Printer
} from 'lucide-react'
...
export default async function DetalhesCandidatoPage({
  ...
  async function atualizarStatus(status: 'Aprovado' | 'Reprovado') {
    await fetch(`/api/candidatos/${id}/status`, {
      method: 'PATCH',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-blue-100 mb-8">
          ...
          <div className="p-4 sm:p-6">
            ...
            <section className="mb-8">
              ...
              <div className="mt-4">
                <p className="text-blue-500 text-sm font-medium">Outros Conhecimentos</p>
        ...
        <div className="flex flex-wrap justify-center sm:justify-between gap-3 mb-6">
          <div className="flex gap-2">
            <Link href={`/candidatos/editar/${id}`} className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
